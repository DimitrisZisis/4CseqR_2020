...
data1 <- read.csv("ranksort_ESC_pcdhb19_1_qnorm.txt",header = F, sep=" ")
data1[1:10,]
data2 <- read.csv("ranksort_ESC_pcdhb19_2_qnorm.txt",header = F, sep=" ")
data2[1:10,]
data3 <- read.csv("ranksort_ESC_pcdhb19_3_qnorm.txt",header = F, sep=" ")
data4 <- read.csv("ranksort_iPSC_pcdhb19_1_qnorm.txt",header = F, sep=" ")
data1[1:10,]
data5 <- read.csv("ranksort_iPSC_pcdhb19_2_qnorm.txt",header = F, sep=" ")
data2[1:10,]
data6 <- read.csv("ranksort_iPSC_pcdhb19_3_qnorm.txt",header = F, sep=" ")
...
table[1:10,]
write.table(table, file = "totalnorm_all_mouse_qnorm.txt" , quote = FALSE,  sep = "\t", row.names=FALSE , col.names=T)


newtab<- read.table(file= "totalnorm_all_mouse_qnorm.txt", header=T, sep="\t")
newtab[1:10,]
...
write.table(df2, file = "totalnorm_all_mm10_qnorm_zero.txt" , quote = FALSE,  sep = " ", row.names=FALSE , col.names=FALSE)
