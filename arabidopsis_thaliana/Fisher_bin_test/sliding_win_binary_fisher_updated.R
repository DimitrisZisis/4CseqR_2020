...
newdata.dt <- fread("totalnorm_all_arab_binary_zero.txt")
...
# write file to getwd()
write.table(output.dt, file = "Fisher_bintest_10000000_50_alltable_arab.csv", col.names = T, row.names = F, quote = F, sep = "\t")
